...
import silverBadge from '@/assets/silber copy.webp';
import goldBadge from '@/assets/gold copy.webp';
import platinumBadge from '@/assets/plartinum copy.webp';
import diamondBadge from '@/assets/diamant copy.webp';
import legendsBadge from '@/assets/legends.webp';
import mastersBadge from '@/assets/masters copy.webp';
