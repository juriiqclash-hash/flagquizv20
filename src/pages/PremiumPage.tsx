  ...
  const plans: PricingPlan[] = [
    {
      ...
      features: [
        'Nur 3 Accounts gleichzeitig gespeichert',
        'Maximum von 30 in Freundesliste',
        'Land nur 5x pro Monat änderbar',
        'Benutzername nur 1x pro Monat änderbar',
    ...
    },
    {
      ...
      features: [
        'Übersetzen in mehr Sprachen',
        'Mehr als 3 Benutzerkonten gleichzeitig eingeloggt behalten',
        'Profil-View anpassen (Hintergrundfarbe, Benutzername-Farbe)',
        'Benutzername unlimitiert ändern',
        'Herkunftsland unlimitiert ändern',
        'Freundesliste unlimitiert erweitern',
        'Clans mit 30+ Usern erstellen',
      ],
    ...
    },
    {
      ...
      features: [
        ...
        'Spezielle Badge im Profil',
        'Spezieller Rahmen im Profil',
        'Gesamtes Design des Menüs anpassen',
        'Zugriff auf exklusive Quiz',
        'Zugriff auf noch nicht veröffentlichte Features',
        'Exklusive Rolle im Discord',
        'Doppelt so viel XP',
        'Rang-Boost',
      ],
