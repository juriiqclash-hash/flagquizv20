  ...
  const plans: PricingPlan[] = [
    {
      ...
      description: t.freePlanDesc || 'Kostenlos',
      features: [
        t.freeFeature1 || 'Enthält Werbung',
        t.freeFeature2 || 'Zugriff auf Standard-Quizkategorien',
        t.freeFeature3 || 'Öffentlicher Multiplayer',
        t.freeFeature4 || 'Kein Offline-Modus',
      ],
    ...
    {
      id: 'premium',
      name: t.premiumPlan || 'FlagMaster',
      price: { monthly: '3.99', yearly: '19.99' },
      description: t.premiumPlanDesc || 'Premium',
      features: [
        t.premiumFeature1 || 'Werbefrei',
        t.premiumFeature2 || 'Exklusive Quiz-Kategorien',
        t.premiumFeature3 || 'Detaillierte Statistiken',
        t.premiumFeature4 || 'Profilbanner & Avatare',
        t.premiumFeature5 || 'Offline-Modus',
      ],
    ...
    {
      id: 'ultimate',
      name: t.ultimatePlan || 'World Genius',
      price: { monthly: '7.99', yearly: '39.99' },
      description: t.ultimatePlanDesc || 'Ultimate',
      features: [
        t.ultimateFeature1 || 'Alle Premium-Features',
        t.ultimateFeature2 || 'Eigene Quiz erstellen',
        t.ultimateFeature3 || 'Turniere & Ranglisten',
        t.ultimateFeature4 || 'Team-Modus',
        t.ultimateFeature5 || 'Früher Zugang zu neuen Themen',
      ],
