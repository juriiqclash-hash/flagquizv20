    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 z-20 bg-white/10 backdrop-blur-sm border-b border-white/20">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <Select value={language} onValueChange={setLanguage}>
            <SelectTrigger className="w-[160px] bg-transparent text-white border-transparent hover:bg-white/10">
              ...
              >
                ...
                {searchExpanded && (
                  <Input
                    ...
                    className="bg-white/10 border-white/20 text-white placeholder:text-white/60 h-10 focus-visible:ring-0 pr-4"
                    autoFocus
                  />
                )}
              </div>
      ...
      <div className="hidden lg:flex absolute bottom-6 left-6 z-10 flex-col gap-5 scale-90 origin-bottom-left" style={{ width: '420px' }}>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 border-2 border-white/30" style={{ height: '280px' }}>
          <div className="flex flex-col h-full">
            <h3 className="text-white text-xl font-bold mb-2">{t.quickAccess}</h3>
            ...
            <div className="flex-1 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl p-6 border border-white/10 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center justify-start h-full gap-2 pt-2">
