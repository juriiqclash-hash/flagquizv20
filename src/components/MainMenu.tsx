  ...
  return <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{
    ...
    backgroundPosition: "center"
        ...
        height: '280px'
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl py-6 px-8 border border-white/10 relative overflow-hidden flex flex-col items-center justify-center gap-2">
              ...
              <Button onClick={handleMultiplayer} className="bg-gradient-to-b from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white font-bold px-12 py-3 rounded-full transition-all duration-300 shadow-lg -mt-1 border-4 border-green-700 hover:border-green-800 hover:shadow-[0_0_30px_rgba(34,197,94,0.6)]">
      ...
      width: '420px'
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-5 border-2 border-white/30 transition-all duration-300 hover:bg-white/15">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={handleDailyChallenge} className="bg-gradient-to-b from-purple-400 to-purple-600 hover:from-purple-500 hover:to-purple-700 text-white font-bold px-10 py-3 rounded-full transition-all duration-300 shadow-lg flex-shrink-0 border-4 border-purple-700 hover:border-purple-800 hover:shadow-[0_0_30px_rgba(168,85,247,0.6)]">
              <span className="text-lg">PLAY</span>
            </Button>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-5 border-2 border-white/30 transition-all duration-300 hover:bg-white/15">
          ...
          <div className="bg-gradient-to-br from-amber-900/40 to-yellow-900/40 rounded-2xl p-5 border border-amber-500/30">
            <div className="flex items-center justify-between">
              ...
              <Button onClick={() => navigate('/premium')} className="bg-gradient-to-b from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold px-10 py-3 rounded-full transition-all duration-300 shadow-lg flex-shrink-0 border-4 border-yellow-700 hover:border-yellow-800 hover:shadow-[0_0_30px_rgba(234,179,8,0.6)]">
      ...
      {isMobile ? <div className="relative z-10 flex flex-col items-center justify-start w-full px-4 pt-20 pb-8 overflow-y-auto max-h-[calc(100vh-64px)]">
          ...
          <Button onClick={handleStart} size="lg" className="bg-blue-600 hover:bg-blue-700 text-white text-xl py-6 px-12 rounded-2xl shadow-2xl transition-all duration-300 hover:scale-105 mb-12 border-4 border-blue-800 hover:border-blue-900 hover:shadow-[0_0_30px_rgba(37,99,235,0.6)]">
          ...
          <div className="w-full max-w-md flex flex-col gap-5">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-5 border-2 border-white/30">
              ...
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl py-5 px-6 border border-white/10 flex flex-col items-center justify-center gap-2">
                ...
                <Button onClick={handleMultiplayer} className="bg-gradient-to-b from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white font-bold px-10 py-2 rounded-full transition-all duration-300 shadow-lg border-3 border-green-700 hover:border-green-800 hover:shadow-[0_0_20px_rgba(34,197,94,0.6)]">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-4 border-2 border-white/30 transition-all duration-300 active:bg-white/15">
              <div className="flex items-center justify-between">
                ...
                <Button onClick={handleDailyChallenge} className="bg-gradient-to-b from-purple-400 to-purple-600 hover:from-purple-500 hover:to-purple-700 text-white font-bold px-6 py-2 rounded-full transition-all duration-300 shadow-lg border-3 border-purple-700 hover:border-purple-800 hover:shadow-[0_0_20px_rgba(168,85,247,0.6)]">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-4 border-2 border-white/30 transition-all duration-300 active:bg-white/15">
              ...
              <div className="bg-gradient-to-br from-amber-900/40 to-yellow-900/40 rounded-2xl p-4 border border-amber-500/30">
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => navigate('/premium')} className="bg-gradient-to-b from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold px-6 py-2 rounded-full transition-all duration-300 shadow-lg flex-shrink-0 border-3 border-yellow-700 hover:border-yellow-800 hover:shadow-[0_0_20px_rgba(234,179,8,0.6)]">
          ...
          <Button onClick={handleStart} size="lg" className="bg-blue-600 hover:bg-blue-700 text-white text-2xl py-8 px-16 rounded-2xl shadow-2xl transition-all duration-300 hover:scale-105 scale-90 border-4 border-blue-800 hover:border-blue-900 hover:shadow-[0_0_30px_rgba(37,99,235,0.6)]">
