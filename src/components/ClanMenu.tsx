...
import { Shield, X, Plus, Users, Crown, Upload } from 'lucide-react';
...
const MOCK_CLANS: Clan[] = [
  ...
  },
  {
    ...
    name: 'Lemuria',
    emoji: '🌺',
    description: 'Das verlorene Paradies. Gemeinsam erobern wir die Bestenlisten.',
    members: [],
    maxMembers: 30,
              ...
              <div>
                ...
                {selectedClan.members.length > 0 ? (
                  ...
                  <div className="py-12 text-center bg-gray-50 rounded-2xl">
                    ...
                    <p className="text-gray-500 font-medium">Noch keine Mitglieder</p>
                    <p className="text-sm text-gray-400 mt-1">Sei der Erste, der diesem Clan beitritt!</p>
                  </div>
                )}
              </div>
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-4 max-h-[calc(100vh-240px)] overflow-y-auto pr-2">
          {MOCK_CLANS.map((clan) => (
            <Card
              key={clan.id}
              className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all cursor-pointer group"
              onClick={() => setSelectedClan(clan)}
            >
              <div className="flex items-center gap-6 p-6">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl shadow-lg flex items-center justify-center text-5xl flex-shrink-0 group-hover:scale-110 transition-transform">
                  {clan.emoji}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-full flex-shrink-0 ml-4">
