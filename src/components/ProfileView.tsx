...
export const ProfileView = ({
  ...
  if (!open) return null;
  return <>
      <div className="fixed inset-0 z-50 bg-gradient-to-br from-blue-950 via-blue-800 to-blue-900 flex items-end justify-center p-4 pb-6">
        {/* Close Button */}
        ...
        <div className="w-full max-w-7xl flex flex-col">
          ...
          <div className="flex items-start mb-3 md:mb-4 md:pl-2">
