...
export const PublicProfileView = ({
  ...
  return <>
              ...
              <div className="flex-1 flex flex-col items-center md:items-start w-full">
                ...
                {currentUser && currentUser.id !== userId && <div className="flex gap-2 justify-center md:justify-start flex-wrap relative z-10 pointer-events-auto">
                    {friendshipStatus === 'none' && <Button 
                        ...
                        className="bg-gradient-to-b from-blue-400 to-blue-600 hover:from-blue-500 hover:to-blue-700 text-white font-bold px-8 py-3 rounded-full transition-all duration-300 shadow-lg pointer-events-auto cursor-pointer"
                      >
                        <UserPlus className="w-4 h-4 mr-2" />
                        Freund hinzufügen
                      </Button>}
                    {friendshipStatus === 'pending_sent' && <Button 
                        onClick={cancelFriendRequest} 
                        className="bg-gradient-to-b from-gray-400 to-gray-600 hover:from-gray-500 hover:to-gray-700 text-white font-bold px-8 py-3 rounded-full transition-all duration-300 shadow-lg pointer-events-auto cursor-pointer"
                      >
                        <Clock className="w-4 h-4 mr-2" />
                        Anfrage gesendet
                      </Button>}
                    {friendshipStatus === 'pending_received' && <Button 
                        onClick={acceptFriendRequest} 
                        className="bg-gradient-to-b from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white font-bold px-8 py-3 rounded-full transition-all duration-300 shadow-lg pointer-events-auto cursor-pointer"
                      >
                    ...
                    {friendshipStatus === 'friends' && <Button 
                        ...
                        className="bg-gradient-to-b from-red-400 to-red-600 hover:from-red-500 hover:to-red-700 text-white font-bold px-8 py-3 rounded-full transition-all duration-300 shadow-lg pointer-events-auto cursor-pointer"
                      >
      ...
      {showRankInfo && <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[105]">
      ...
      {showClanView && userClanId && <div className="z-[105]"><ClanDetailModal
        clanId={userClanId}
